...
Aggregated_Transaction = pd.read_sql('SELECT * FROM Aggregated_Transaction_Table', con=cnx)
...
Average_transaction = pd.DataFrame(Aggregated_Transaction['Total_Amount'].values/
                                   Aggregated_Transaction['Total_Transactions'].values,
                                   columns=['Avg_transaction'])
